document.addEventListener('DOMContentLoaded', function() {
    const calendar = new FullCalendar.Calendar(document.getElementById('calendar'), {
        ...
        events: [
            ...
            { title: 'Keynote: Aaron Steven White\nUnderstanding Complex Situation Descriptions', start: '2025-08-04T17:05', end: '2025-08-04T18:00', extendedProps: { type: 'keynote', link: 'keynote1' } },
            ...
            { title: 'Keynote: Kyle Richardson\nUnderstanding the Logic of Generative AI through Logic', start: '2025-08-08T17:00', end: '2025-08-08T17:55', extendedProps: { type: 'keynote', link: 'keynote3' } },
            { title: 'How Often does Natural Logic Actually Meet Machine Learning?', start: '2025-08-08T17:55', end: '2025-08-08T18:20', extendedProps: { type: 'contributed', link: 'talk8' } },
            // { title: 'Closing', start: '2025-08-08T17:55', end: '2025-08-08T18:00', extendedProps: { type: 'special' } },
            { title: 'Closing', start: '2025-08-08T18:20', end: '2025-08-08T18:25', extendedProps: { type: 'special' } },
        ]
    });
    calendar.render();
});